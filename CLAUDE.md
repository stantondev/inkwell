...
- **Frontend**:
  - `apps/web/src/app/settings/newsletter/page.tsx` — enable toggle, subscriber count, subscribe URL, newsletter name/description/reply-to (Plus-gated)
  ...
  - `apps/web/src/app/[username]/profile-subscribe-widget.tsx` — sidebar subscribe widget on profile pages
...
### Settings Tabs
Profile | Top 6 | Filters | Billing | Customize | Newsletter
