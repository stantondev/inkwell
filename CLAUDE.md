...
- **Key files**:
  - `apps/web/src/components/live-nav-counts.tsx` — core hook: polling, sound synthesis, title management, favicon badge, visibility handling
  - `apps/web/src/app/settings/content-safety.tsx` — mute toggle (alongside existing "Show sensitive content" toggle)
