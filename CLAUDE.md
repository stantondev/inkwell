...
- Free tier: 500 subscriber limit; Plus: unlimited subscribers, custom newsletter name, custom reply-to, scheduled sends, full send history
...
**Recommended next**: Newsletter cost controls (send limits per tier), then Update Comments (score 70), then Clubs (Plus-gated creation, ~5 day MVP).
