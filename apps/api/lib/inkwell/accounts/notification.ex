defmodule Inkwell.Accounts.Notification do
  ...
  schema "notifications" do
    field :type, Ecto.Enum, values: [:comment, :follow_request, :follow_accepted, :mention, :community_invite, :tip, :like, :stamp, :feedback_status_change, :feedback_comment, :feedback_vote]
