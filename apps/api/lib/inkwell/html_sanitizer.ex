defmodule Inkwell.HtmlSanitizer do
  ...
  @safe_attributes %{
    ...
    "div" => ~w(class style data-spacing data-circle-embed data-inkwell-widget data-photo-gallery data-gallery-layout data-gallery-columns),
    ...
    "figure" => ~w(class data-gallery-photo data-image-id data-photo-order),
    "h1" => ~w(class style),
    "h2" => ~w(class style),
    "h3" => ~w(class style),
    "h4" => ~w(class style),
