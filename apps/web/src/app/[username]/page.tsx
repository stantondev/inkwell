      ...
      <div id={profileScopeId} className={`mx-auto px-3 sm:px-4 ${isOnCustomDomain ? "lg:px-8 xl:px-12" : ""} py-8 overflow-hidden ${isOnCustomDomain ? "" : layout === "minimal" ? "max-w-2xl" : "max-w-7xl"}`}
        ...
        <header className={`profile-header-card ${styles.borderRadius} border overflow-hidden mb-8`} style={styles.surface}>
          ...
          <div className="px-4 sm:px-6 pb-4 sm:pb-6">
            ...
            {/* Muse AI bot notice */}
            {profile.username === "muse" && (
              <div
                className="mb-4 rounded-xl border p-3 text-sm italic flex items-center gap-2"
              ...
              >
                ...
                Muse is Inkwell&apos;s AI writing companion. All content is generated by AI and clearly labeled.
              </div>
            )}
