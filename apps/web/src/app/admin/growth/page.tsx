  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-xl font-semibold" style={{ fontFamily: "var(--font-lora, Georgia, serif)" }}>Growth</h1>
          <p className="text-sm mt-1 max-w-2xl" style={{ color: "var(--muted)" }}>
            Where new accounts come from, and which sources turn into writers and paying members.
            Spam accounts that were suspended are left out. Add <code>?ref=something</code> to any link you share
