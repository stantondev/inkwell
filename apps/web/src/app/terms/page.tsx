    ...
    >
      ...
      <div className="prose-legal flex flex-col gap-8 text-base leading-relaxed">
        ...
        <section>
          ...
          <p className="mt-3">
            Certain usernames are reserved by Inkwell and may not be registered. These include any username containing
            or beginning with &quot;inkwell&quot; (such as &quot;inkwell&quot;, &quot;inkwell123&quot;, &quot;inkwellofficial&quot;,
            or any other variation), names that impersonate platform roles (such as &quot;admin&quot; or &quot;moderator&quot;),
            and names that conflict with system routes. The &quot;inkwell&quot; name and brand are exclusively reserved for
            official use. We reserve the right to reclaim or reassign any username at any time, including usernames that were
            registered before a reservation was put in place. Affected users will be notified and given the opportunity to
        ...
        <section>
          ...
          <ol className="list-[lower-alpha] pl-6 mt-3 flex flex-col gap-2">
            ...
            <li>
              ...
              without our prior written consent, including for the purpose of training artificial intelligence or machine
              learning models;
            </li>
        ...
        <section>
          ...
          <h3 className="font-semibold mt-4 mb-2">7.1 No AI Training on User Content</h3>
          <p>
            Inkwell does not use user-generated content to train artificial intelligence or machine learning models. We do
            not sell, license, or provide user content to third parties for the purpose of AI model training.
          </p>

          <h3 className="font-semibold mt-4 mb-2">7.2 Prohibited AI Scraping</h3>
          <p>
            Automated access to Inkwell for the purpose of collecting data to train AI or machine learning models is
            prohibited, regardless of the method used &mdash; including web crawling, scraping, API abuse, or any other
            automated means. This prohibition applies even if the data is publicly accessible.
          </p>

          <h3 className="font-semibold mt-4 mb-2">7.3 AI-Generated Content Disclosure</h3>
          <p>
            Users who post content that is substantially generated by AI are encouraged to disclose this to the community.
            Fully automated AI posting &mdash; accounts that publish AI-generated content without meaningful human
            curation &mdash; may be removed at our discretion.
          </p>
        ...
        <section>
          <h2
            ...
            style={{ fontFamily: "var(--font-lora, Georgia, serif)" }}
          >
            9. Paid Subscriptions (Inkwell Plus)
          </h2>

          <h3 className="font-semibold mt-4 mb-2">9.1 Billing and Renewal</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">9.2 Cancellation</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">9.3 Refunds</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">9.4 Price Changes</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">9.5 Payment Processing</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">9.6 External Support Links</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">9.7 Postage (Plus Feature)</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">9.8 Newsletter Send Limits</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">9.9 API Access</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">9.10 Writer Subscription Plans (Paid Content)</h3>
          <p>
        ...
        {/* 9.11. Custom Domains */}
        <section>
          <h3 className="font-semibold mt-4 mb-2">9.11 Custom Domains (Plus Feature)</h3>
          <p>
        ...
        <section>
          ...
          <h3 className="font-semibold mt-4 mb-2">11.1 By You</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">11.2 By Inkwell</h3>
          <p>
          ...
          <h3 className="font-semibold mt-4 mb-2">11.3 Effect of Termination</h3>
          <p>
            Upon termination, your right to use the Service immediately ceases. Sections 4, 5, 13, 14, 15, and 16
            survive termination.
          </p>
        </section>
