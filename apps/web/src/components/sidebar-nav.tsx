...
function GazetteIcon() { return <svg {...iconProps}><path d="M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z" /><path d="M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z" /></svg>; }
...
function ReadersIcon() { return <svg {...iconProps}><line x1="6" y1="20" x2="6" y2="13" /><line x1="12" y1="20" x2="12" y2="6" /><line x1="18" y1="20" x2="18" y2="10" /></svg>; }
    ...
    <>
      ...
      <div className="sidebar-section">
        ...
        <div className="sidebar-write-row">
          ...
          <button
            type="button"
            className="sidebar-jot-btn"
            onClick={openJot}
            title="Jot a Sticky: a short thought"
          >
            <StickyIcon />
            <span className="sidebar-nav-label">Jot a sticky</span>
          </button>
        </div>
      </div>
