...
export const GUIDELINES_PAGES: GuidelinePage[] = [
  ...
  },
  {
    ...
    body: [
      "Reader-to-writer payments \u2014 paid subscription plans and Postage \u2014 are paused while we sort out a new payment processor. You can\u2019t charge readers on Inkwell today. Everything below is how it will work when they return.",
      ...
      "If a subscriber cancels, they keep access until the end of the period they paid for. No hard feelings.",
  ...
  },
  {
    ...
    body: [
      ...
      "Fully automated AI accounts are not permitted. Every account on Inkwell should have a real person behind it.",
      "The best entries on Inkwell are the ones that could only have been written by you.",
    ],
  },
  {
    id: "enforcement",
