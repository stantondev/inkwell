...
export const HELP_ENTRIES: HelpEntry[] = [
  ...
  { id: "w-userpics", title: "Userpics", snippet: "Pictures with keywords, chosen per entry and footnote, LiveJournal-style.", keywords: ["userpic", "icon", "picture", "avatar", "keyword", "gif", "livejournal"], category: "customization", href: "/help/faq#userpics" },
  { id: "w-classic", title: "Classic view (2004)", snippet: "See Feed and Explore as a LiveJournal-style friends page.", keywords: ["classic", "livejournal", "2004", "retro", "old look", "friends page", "look and feel", "theme"], category: "customization", href: "/help/faq#classic-view" },
  { id: "w-moods", title: "Moods, music and location", snippet: "Pick a mood and its face, choose Classic or Ink icons, and add where you are.", keywords: ["mood", "feeling", "icon", "face", "smiley", "livejournal", "current mood", "location", "music"], category: "writing", href: "/help/faq#moods" },
  ...
  { id: "s-circles", title: "Circles (writing communities)", snippet: "Join a circle, start threads with journal entries, and answer other members' threads.", keywords: ["circle", "group", "community", "thread", "prompt", "members only", "reddit", "forum"], category: "social", href: "/help/faq#circles" },
