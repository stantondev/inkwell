...
export const HELP_ENTRIES: HelpEntry[] = [
  ...
  { id: "w-userpics", title: "Userpics", snippet: "Pictures with keywords, chosen per entry and footnote.", keywords: ["userpic", "icon", "picture", "avatar", "keyword", "gif"], category: "customization", href: "/help/faq#userpics" },
  { id: "w-classic", title: "Classic view (2004)", snippet: "See Feed and Explore the way journals looked in 2004.", keywords: ["classic", "2004", "retro", "old look", "early web", "look and feel", "theme"], category: "customization", href: "/help/faq#classic-view" },
  { id: "w-moods", title: "Moods, music and location", snippet: "Pick a mood and its face, choose Classic or Ink icons, and add where you are.", keywords: ["mood", "feeling", "icon", "face", "smiley", "current mood", "location", "music"], category: "writing", href: "/help/faq#moods" },
