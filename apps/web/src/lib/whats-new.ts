...
export const WHATS_NEW: WhatsNewItem[] = [
  {
    ...
    body: "You can now share a link or text from any app straight into Inkwell (on Android once Inkwell is on your home screen, on iPhone with a free Shortcut) and jot it as a sticky or start an entry with it. On iPhone and iPad the app opens on an Inkwell launch screen (light or dark, to match your phone) instead of a blank white one. And there's an optional touch of fun: turn on Tilt effects and stamps, archive postmarks and avatar frames shift and catch the light as you tilt your phone.",
    howTo: "Share: on Android, pick Inkwell in your phone's Share menu; on iPhone, add the free “Share to Inkwell” Shortcut first (two minutes, steps in the guide). Tilt: Settings → Look & feel → Tilt effects.",
    href: "/help/share-to-inkwell",
    cta: "Set up sharing",
    tag: "Mobile",
  },
  {
